...
from utils.mvtec_dataloader import get_train_test_loaders, get_cv_train_test_loaders
from utils.vgg16_defect_detector import AnomalyDetector
...
def predict(model_path = "weights/leather_model.h5", image_path = "data/mvtec_defect_detection/leather/test/cut/004.png"):
...
def train_model(data_folder= "data/mvtec_defect_detection", subset_name= "leather"):
...
if __name__ == '__main__':
    if len(sys.argv) <= 1:
        ...
        train_model("data/mvtec_defect_detection", "leather")
